        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FistName = table.Column<string>(type: "nvarchar(50)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "FistName", "LastName", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "صالح", "محمد", "465" },
                    { 2, "علي", "احمد", "56465" }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "حلقة عمرابن الخطاب", 1 },
                    { 2, "حلقة عي ابن بي طالب", 2 }
                });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "FistName", "HalaqaId", "LastName", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "سالم", 1, "علي", "564645" },
                    { 2, "ناصر", 2, "فادي", "564651" }
                });
